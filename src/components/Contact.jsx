    ...
    <div name='contact' className='w-full h-screen bg-gradient-to-b from-black to-gray-800 text-white' >
      ...
      <div className='flex flex-col p-4 justify-center max-w-screen-lg mx-auto h-full' >
        ...
        <div className=' flex justify-center items-center ' >
            <form action="https://wa.me/+40725746804" target='_blank' method='POST' className='flex flex-col w-full md:w-1/2  ' >
                ...
                <textarea placeholder='Enter your message' name="message" rows="10" className=' p-2 bg-transparent border-2 rounded-md text-white focus:outline-none min-h-[40%] '></textarea>
